...
async def musicme(client, message):
       ...
       if message.chat.id not in disable:
         ...
         url = f"https://t.me/NO1BROS/{rl}"
         await message.reply_voice(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  •](t.me/NO1BROS)")
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/NO1BROS/{rl}"
         await message.reply_photo(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  •](t.me/NO1BROS)")
...
async def qw2(client,message):
       ...
       if message.chat.id not in disable_G:
         ...
         url = requests.get(f"https://t.me/NO1BROS/{rl}").text
