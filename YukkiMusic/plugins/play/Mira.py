...
def vgdg(client,message):
        message.reply_text(
            f"""✧ Welcome Baby,
ᴅᴇᴠᴇʟᴏᴘᴇʀ -› [Khaled ♪](t.me/SSxHH)
ᴄʜᴀɴɴᴇʟ -› [𝑺𝒐𝒖𝒓𝒄𝒆  𝐂𝐑𝐘𝐒𝐓𝐀𝐋 ](t.me/NO1BROS)""", 
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "تحديثات كرستال 🍻", url=f"t.me/NO1BROS")
                    ]
                ]
            ),
...
@app.on_message(filters.command("كرستال نادي المطور", [".", ""]) & filters.group)
async def kstr(client: Client, message: Message):
       ...
       await message.reply_text(
        f"""- **ابشر ياعيوني ارسلت للمطور بيخش القروب ويشوف مشكلتك بأقرب وقت\n\n- تابع قناة البوت عشات تشوف التحديثات** -› [• Source Mira •](t.me/NO1BROS)""", disable_web_page_preview=True     
    )
...
@app.on_message(filters.regex("^كرستال$"))
...
async def down(client, message):
          m = await message.reply("**- ابشر تم اخفاء الازرار بنجاح\n- لو تبي تطلعها مرة ثانية اكتب كرستال**", reply_markup= ReplyKeyboardRemove(selective=True))


@app.on_message(filters.group & command("كيفية استخدام كرستال"))
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""- **هلا والله ياعيني عشان تفعل بوت كرستال اتبع الخطوات الي بالاسفل**
1 • ارفعه مشرف بكل الصلاحيات 
2 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب كرستال شغلي + اسم المقطع الصوتي
• مثال : كرستال شغلي واتنسيت
- لو واجهت مشكله كلم مطور البوت ~ @SSxHH""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "• ضيفني لقروبك 🎻", url=f"https://t.me/K0HBOT?startgroup=true"),
                ],
            ]
        ),
        disable_web_page_preview=True
...
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""**- اهلين فيك بسورس كرستال ياحلو
• لو تبي تنصب مثل هالبوت تواصل مع مطور السورس
• عندك استفسار او اقتراح بخصوص البوت تواصل مع مطور البوت**
مطور السورس -› [Khaled](t.me/SSxHH)
قناة السورس -› [𝑺𝒐𝒖𝒓𝒄𝒆  𝐂𝐑𝐘𝐒𝐓𝐀𝐋 ](t.me/NO1BROS)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
REPLY_MESSAGEE = "- هلا فيك في قسم اوامر كرستال"
...
@app.on_message(filters.group & command("اوامر كرستال"))
...
• AppleMusic
• Spotify
- لو واجهت مشكلة تواصل مع مطور السورس @SSxHH**
- [𝑺𝒐𝒖𝒓𝒄𝒆  𝐂𝐑𝐘𝐒𝐓𝐀𝐋 ](t.me/NO1BROS)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
