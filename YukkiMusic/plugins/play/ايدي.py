...
async def sourc(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""✧ 𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑻𝒐 𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐑𝐘𝐒𝐓𝐀𝐋 ♪\n\n• ᴅᴇᴠᴇʟᴏᴘᴇʀ -› @SSxHH\n• 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  -› @NO1BROS\n\n**- للتنصيب او للاستفسار تواصل مع مطور السورس**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                       "مطور السورس", user_id=5676384368)
                ],[
                    InlineKeyboardButton(
...
async def aboutd5ev(client: Client, message: Message):
    usr = await client.get_chat(5676384368)
    name = usr.first_name
    bio = (await client.get_chat(5676384368)).bio
    async for photo in client.iter_profile_photos(5676384368, limit=1):
                    await message.reply_photo(photo.file_id, caption=f"""- 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝑻𝒐 𝑩𝒐𝒕  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  ♪ -› @SSxHH\n\n- 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓'𝒔 𝑩𝒊𝒐 -› {bio}""", 
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
