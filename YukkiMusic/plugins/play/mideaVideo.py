    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "◌𝐂𝐑𝐘𝐒𝐓𝐀𝐋 𝐌𝐔𝐒𝐈𝐂  ◌", url=f"t.me/NO1BROS  "),
                    InlineKeyboardButton(
...
async def eslam(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton("", url=f"t.me/ei2_o"),
                    InlineKeyboardButton("رجوع", callback_data="ko")
                ],[
                    InlineKeyboardButton("", url=f"t.me/yyybr"),
                ],[
                    InlineKeyboardButton("◌𝐂𝐑𝐘𝐒𝐓𝐀𝐋 𝐌𝐔𝐒𝐈𝐂  ◌", callback_data="fft"),
       ...
       reply_markup=InlineKeyboardMarkup(
            [
                [
                     ...
                     InlineKeyboardButton(
                        "◌𝐂𝐑𝐘𝐒𝐓𝐀𝐋 𝐌𝐔𝐒𝐈𝐂  ◌", callback_data=f"fft"),
