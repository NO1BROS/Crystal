...
async def am(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           "https://telegra.ph/file/94c43633525702295679d.mp4",None,
           "✧ اهلين فيك في اوامر بوت كرستال (:\n\n- **كل اوامر البوت عندك بالازرار تحت استكشفهم بنفسك**\n\n• Developer -› [𝑲𝒉𝒂𝒍𝒆𝒅](t.me/SSxHH)\n• Channel -› [𝑺𝒐𝒖𝒓𝒄𝒆 𝐂𝐑𝐘𝐒𝐓𝐀𝐋 ](t.me/NO1BROS)"
       ),
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
async def sound(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaPhoto(
           ...
           "✧ **اهلين فيك في قسم الاوامر الخدمية**\n-** عندك اوامر كثيرة للتسلية ومنها ↓**\n\n-› **غنيلي\n-› افتارات بنات\n-› افتارات عيال\n-› افتارات مكس\n -› هيدرات او هيدر\n-› اقتباس او اقتباسات\n-› كت**\n\n✶ **ايضا تقدر تتابع قناة كرستال فيها تشكلية كبيرة من كل الي ذكرتهم فوق**\n-› @no2bros"
      ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
                     ...
                     InlineKeyboardButton(
                        "• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  •", url=f"t.me/no2bros")
