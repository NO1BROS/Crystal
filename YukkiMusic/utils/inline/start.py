        ...
        buttons.append(
            [
                ...
                InlineKeyboardButton(
                    ...
                    text=_["S_B_9"], url=f"https://t.me/NO2BROS"
    ...
    if GITHUB_REPO and OWNER:
        ...
        if OWNER:
            buttons.append(
                [
                    InlineKeyboardButton(
                        text=_["S_B_11"], url=f"https://t.me/NO1BROS"
                    ),
                    InlineKeyboardButton(

                        text=_["S_B_12"], url=f"https://t.me/NO1BROS"
            ...
            buttons.append(
                [
                    ...
                    InlineKeyboardButton(
                        ...
                        text=_["S_B_10"], url=f"https://t.me/NO2BROS"
...
@app.on_message(filters.private & command("طريقة تشغيل كرستال"))
...
3 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب كرستال شغلي + اسم المقطع الصوتي

• مثال : كرستال شغلي واتنسيت

- لو واجهت مشكله او ما فهمت خطوة كلم مطور البوت ~ @SSxHH""",
...
مطور السورس -› [مـ𝟐𝟎𝟎𝗸ــمـول كــرستــال 🇮🇶🥂](t.me/SSxHH)
قناة السورس -› [𝐒𝐎𝐔𝐑𝐂𝐄  𝐂𝐑𝐘𝐒𝐓𝐀𝐋](t.me/NO1BROS)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
@app.on_message(filters.private & command("اوامر كرستال"))
